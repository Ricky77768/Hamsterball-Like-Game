...
// Adapted from https://answers.unity.com/questions/542646/3d-text-strokeoutline.html
public class TextOutline : MonoBehaviour {
    ...
    void Start() {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            SortingGroup sg = outline.AddComponent<SortingGroup>();
            sg.sortingOrder = -1;
            ...
            outline.transform.Rotate(Vector3.right, rotateX);
            outline.transform.Rotate(Vector3.back, rotateY);
            outline.transform.Rotate(Vector3.down, rotateZ);
        }
    }
